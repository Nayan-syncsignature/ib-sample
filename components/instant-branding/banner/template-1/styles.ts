...
export const styles: StyleItem[] = [
  ...
  },
  {
    ...
    commonConfig: {
      ...
      textColor: "white",
      backdropConfig: {
        backdropUrl: "https://i.postimg.cc/fb3CkLwy/Ellipse-34.png",
        backdropPosition: "right bottom",
        backdropSize: "",
      },
    },
  },
  {
    ...
    commonConfig: {
      ...
      textColor: "white",
      backdropConfig: {
        backdropUrl: "https://i.postimg.cc/7Zxwwdrt/Rectangle-48.png",
        backdropPosition: "right bottom",
        backdropSize: "",
      },
    },
  },
  {
    ...
    commonConfig: {
      ...
      textColor: "white",
      backdropConfig: {
        backdropUrl: "https://i.postimg.cc/2yK1JrBL/Vector-1.png",
        backdropPosition: "left bottom",
        backdropSize: "contain",
      },
    },
  },
  {
    ...
    commonConfig: {
      ...
      textColor: "white",
      backdropConfig: {
        backdropUrl: "https://i.postimg.cc/4dKy9j0J/Rectangle-48.png",
        backdropPosition: "right bottom",
        backdropSize: "",
      },
    },
  },
  {
    ...
    data: {
      ...
      imageAlt: "Professional headshot",
      buttonText: "Get Started",
      communityButtonText: "BOOK YOUR CONSULTATION CALL NOW. CLICK THE LINK IN BIO.",
      ctaButtonText: "Start Free Trial",
    },
    commonConfig: {
      width: 1584, // Use width from useCanvasDimensions hook
      ...
      textColor: "white",
      backdropConfig: {
        backdropUrl: "https://i.postimg.cc/dVHJj4rD/Vector.png",
        backdropPosition: "right bottom",
        backdropSize: "",
      },
    },
