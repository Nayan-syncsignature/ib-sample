...
//       <div className="mb-6">
//         {/* Main Toolbar */}
//         <div className="flex flex-wrap gap-2 mb-4 p-3 border border-gray-200 rounded-lg bg-gray-50 shadow-sm">
//           {/* Undo/Redo section */}
//           <div className="flex items-center space-x-1 mr-4 bg-white p-1 rounded-md shadow-sm">
//             <button
...
//           {/* Font controls */}
//           <div className="flex items-center space-x-2 mr-4 bg-white p-1 rounded-md shadow-sm">
//             <div className="flex items-center">
//               <Type size={20} className="mr-1" />
//               <select
...
//         <div className="flex flex-wrap gap-4 mb-4 p-3 border border-gray-200 rounded-lg bg-gray-50 shadow-sm">
//           {/* Text color section */}
...
//               <span className="text-sm font-medium">Basic Highlight</span>
//             </div>
//             <div className="flex flex-wrap gap-2 max-w-md">
//               <button
//                 className="w-6 h-6 rounded cursor-pointer border border-gray-300 flex items-center justify-center transition-transform hover:scale-110"
...
//                 <button
//                   key={highlight.name}
//                   className="w-6 h-6 rounded cursor-pointer border border-gray-300 transition-transform hover:scale-110"
//                   style={{
...
//             <div className="flex items-center mb-2">
//               <Highlighter size={16} className="mr-1" />
//               <span className="text-sm font-medium">Styled Highlight</span>
//             </div>
//             <div className="flex flex-wrap gap-2 max-w-md">
//               {styledHighlights.map((style, index) => (
//                 <button
//                   key={index}
//                   className="px-2 py-1 rounded cursor-pointer border border-gray-300 text-sm transition-all hover:shadow-md"
//                   style={{
...
//         <div
//           ref={editorRef}
//           className="w-full p-4 min-h-40 border border-gray-300 rounded-lg font-sans outline-none shadow-inner bg-white"
...
//           <div className="w-full p-6 border border-gray-200 rounded-lg min-h-40 flex items-center justify-center bg-white shadow-md">
//             <div
